...
public class PermissionController {
    ...
    public ResponseEntity listPermissionWithParName(@RequestBody Permission permission, @RequestParam(value="pn",defaultValue = "1")Integer pn, @RequestParam(value="pageSize",defaultValue = "10")Integer pageSize){
    ...
    public ResponseEntity addOrEditPermission(@RequestBody Permission permission){
        if(permission==null){
