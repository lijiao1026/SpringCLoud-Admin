...
public class RoleController {
   ...
   // ShiroFeign shiroFeign;
    ...
    public ResponseEntity listRole(@RequestBody Role role, @RequestParam(value="pn",defaultValue = "1")Integer pn, @RequestParam(value="pageSize",defaultValue = "10")Integer pageSize,@RequestParam(value="notAllowPage",defaultValue ="0") Integer notAllowPage){
        if(notAllowPage>0){
    ...
    @PostMapping("/role")
    public ResponseEntity addOrEditRole(@RequestBody Role role){
        if(role==null){
